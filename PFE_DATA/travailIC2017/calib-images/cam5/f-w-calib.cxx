...
int main(int argc, char **argv)
{
	...
	*/
	...
	cout<<endl<<"Bias of Center :"<<endl;
	BiasCenter.x=abs(intrinsic.at<double>(0,2)-(image[0].size().width)/2);
	BiasCenter.y=abs(intrinsic.at<double>(1,2)-(image[0].size().height)/2);
	cout<<"dx: "<<BiasCenter.x<<endl;
	cout<<"dy: "<<BiasCenter.y<<endl;
	// Sauvegarde des donnes camera dans le fichier xml
	fs <<"intrinsic"<<intrinsic<<"distorsion"<<distCoeffs<<"BiasCenter"<<BiasCenter;
	fs.release();
